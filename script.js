...
if (Math.abs(leftX) < 0.3) leftX = 0;
if (Math.abs(leftY) < 0.3) leftY = 0;

    camera.position.x +=
        Math.cos(yaw) * moveX * 0.1;

    camera.position.z -=
        Math.sin(yaw) * moveX * 0.1;

    camera.position.x -=
        Math.sin(yaw) * moveY * 0.1;

    camera.position.z -=
        Math.cos(yaw) * moveY * 0.1;
...
if (Math.abs(rightX) < 0.3) rightX = 0;
if (Math.abs(rightY) < 0.3) rightY = 0;
...
if (Math.abs(rightX) < 0.15) rightX = 0;
if (Math.abs(rightY) < 0.15) rightY = 0;
...
if (gamepad) {
    ...
    yaw -= gamepad.axes[2] * 0.05;
    pitch -= gamepad.axes[3] * 0.05;
